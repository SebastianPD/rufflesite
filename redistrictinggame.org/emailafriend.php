...
<div style="width:960px; height:653px; margin:0 auto;">
	...
	<div style="width:939px; height:653px; float:left; text-align:left; background:url(graphics/shell_center_grad.gif) repeat-x;" id="siteContent"><div style="width:939px; height:653px; overflow:auto;"><div style="width:629px; height:15px; margin:23px auto 0 auto;" class="pageHeader">Email a Friend</div><div style="width:629px; height:15px; margin:23px auto 0 auto;"><img src="graphics/pg_00_ffffff_ul.gif" width="15" height="15" style="float:left;" alt=""><img src="graphics/trans_spacer.gif" width="599" height="15" style="float:left; background-color:#ffffff;" alt=""><img src="graphics/pg_00_ffffff_ur.gif" width="15" height="15" style="float:right;" alt=""></div>
		<div style="width:629px; background:#ffffff; margin:0 auto 0 auto;">
			<div style="padding-top:5px; padding-bottom:5px; margin-left:12px; margin-right:12px; color: #000000;"><form name="emailafriend" action="emailafriend.php" method="post">
Send a message to your friends telling them about the Redistricting Game. Enter their addresses, add something to our message, and click the "Send Mail" button.<br><br>

Enter your friends' e-mail addresses here, separated by commas:<br>
<input type="text" name="addresses" value="" size="30" style="width:600px"><br><br>

Type Your Message Here:<br>
<textarea name="message" cols="60" rows="10" style="width:600px">I've been playing this cool game called The Redistricting Game. Check it out at http://www.redistictringgame.org/ !</textarea><br><br>

<input type="hidden" name="checkout" value="2eeff3">
<input type="image" src="graphics/btn/pg_03_send_mail.gif" width="140" height="43"><br><br>
